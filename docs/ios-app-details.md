...
| ----------------------------------------- | ---------------------------------------------------------------------- | ---------------------------- | -------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| Lifecycle (ring / eyes)                   | `slicc-agent-tabs.ts:118-125`, `presentation.ts:184`                   | `state` (:933)               | yes (:222)                       | row avatar eyes + phrase, `ThreadListRow.activityPhrase`                                                         |
| Phase thinking / tool (pin shape)         | `slicc-agent-tabs.ts:116-120`                                          | `activity` (:949)            | yes (:226)                       | avatar expression + "thinking"/"running a tool"                                                                  |
| Awaiting user                             | `wc-tray-scoops.ts:49`, `slicc-agent-tabs.ts:207`                      | `activity: awaiting`         | yes                              | avatar gaze + "waiting for you"                                                                                  |
| Context fill (arc / pupils)               | `slicc-agent-tabs.ts:261`                                              | `fill` (:951)                | yes (:228)                       | pupils + `NN%`                                                                                                   |
| Near limit ≥75 (amber)                    | `slicc-scoop-overflow.ts:186`                                          | `fill`                       | yes                              | amber `NN%` (`ScoopStatus.isNearLimit`)                                                                          |
| Broken (red ring)                         | `slicc-agent-tabs.ts:121`                                              | `state`                      | yes                              | dead eyes + red "broken"                                                                                         |
...
| Kind cone / scoop                         | `presentation.ts:209`                                                  | `parentId` (:908), `isCone`  | yes (:215)                       | "cone"/"scoop" text, `UnitRole`                                                                                  |
...
| Read-only                                 | composer only (`wc-follower.ts:716`), no tab mark                      | `parentId`                   | yes                              | eye glyph + "read-only" (`UnitRole.isReadOnly`)                                                                  |
| Leader-active unit                        | none (web follower selects it, `wc-tray.ts:618`)                       | `scoops.list.activeScoopJid` | yes                              | radio-waves glyph                                                                                                |
| Per-unit model                            | model pill for the selected cone only (`presentation.ts:68`)           | `model` (:983)               | yes (:233)                       | `model.id` in the detail line                                                                                    |
