...
| **tar**                                     | `tar-command.ts`           | Create, extract, or list tar archives in the VFS, with optional gzip compression and automatic gzip detection when reading. In list/extract mode, path operands select exact members and directory descendants. `-C` changes the input base directory in create mode and the output directory in extract mode.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `(-c\|-x\|-t) [-zv] -f <archive> [-C <dir>] [paths...]`                                                                                                                                                                                                                                                                                         |
