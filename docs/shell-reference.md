...
| **kev**                                                     | `kev-command.ts`           | Typed decisions from a Kev model (yes/no, choice, rating) over piped text, a file, `computer text`, or a snapshot. Weights download on the first `ask` (default Kev-0.8B, about 822 MB; `--model 4b` and `9b` are multi-gigabyte). Needs `ipk add onnxruntime-web`, the same package `say` and `hear` use. The library loads lazily, off the worker first-load graph. `--json` prints the System One response. Skill: `/workspace/skills/kev/SKILL.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `kev ask billing:noul:Is this billing?`, `kev ask --state ticket.txt --questions q.json --json`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **cua-s1**                                                  | `cua-s1-command.ts`        | Form decisions from Cua's cua-s1-forms model (3.3 MB, CPU). `elements` maps a `playwright-cli snapshot` to Edit / CheckBox / Button. `plan` scores those fields against a document's `Label: value` lines and does not touch the page. `commands` prints `playwright-cli fill`, `check`, and `click` lines for the ordered actions. Submit stays off unless `--allow-submit`. Links, radios, and selects are left out. Needs `ipk add onnxruntime-web`. Skill: `/workspace/skills/cua-s1/SKILL.md`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `cua-s1 elements --snapshot form.txt`, `cua-s1 plan --snapshot form.txt --document intake.txt --json`, `cua-s1 commands --plan plan.json --tab E9A3F`                                                                                                                                                                                                                                                                                                                                                                                                                                                |
