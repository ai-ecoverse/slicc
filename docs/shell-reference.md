...
| **pdftoppm / pdftocairo**                   | `pdftoppm-command.ts`      | Rasterize PDF pages to PNG/JPEG via pdf.js (poppler-style flags). Requires `OffscreenCanvas`, so it is unavailable in the Node CLI float                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | `pdftoppm -png -r 150 doc.pdf page`, `pdftoppm -jpeg -singlefile -f 2 doc.pdf cover`                                                                                                                                                                                                                                         |
