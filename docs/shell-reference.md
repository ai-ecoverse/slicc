...
| **tar**                                     | `tar-command.ts`           | Create, extract, or list tar archives in the VFS, with optional gzip compression and automatic gzip detection when reading                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `(-c\|-x\|-t) [-zv] -f <archive> [-C <dir>] [paths...]`                                                                                                                                                                                                                                                                                         |
