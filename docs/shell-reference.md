...
| **agent**                                   | `agent-command.ts`         | Spawn an ephemeral one-shot sub-scoop via `globalThis.__slicc_agent`. Shell surface for scoop delegation that works from any float. Inherits the parent's model when invoked from inside a scoop shell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `agent "<prompt>"`, `--cwd <path>`, `--read-only`, `--writable <path>` (repeatable), `--visible <path>` (repeatable)                        |
| **discover**                                | `discover-command.ts`      | List installed skills (workspace + read-only compat roots) with their `description` and source path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `--all`, `--json`                                                                                                                           |
...
| **fswatch**                                 | `fswatch-command.ts`       | Watch VFS paths and dispatch licks to scoops on changes. Backed by `LickManager`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `fswatch add <name> <path-glob> <scoop> "<instructions>"`, `fswatch list`, `fswatch delete <id>`                                            |
