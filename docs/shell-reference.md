...
| **ssh**                                     | `ssh-command.ts`           | Run a command on a connected tray follower. `ssh <runtime-id> <command>` runs it on the follower (a `slicc … follow` CLI runs it on its real OS, as the user who started it) and returns the buffered stdout/stderr/exit; `ssh --list` shows exec-capable followers (the `[ssh]`-tagged rows in `host`), each with the follower's advertised MOTD. Only a `slicc … follow` follower accepts commands; browser/iOS followers have no OS shell. Ctrl+C interrupts the remote command.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `<runtime-id> <command...>`, `--list`/`-l`, `--cwd <dir>`, `--timeout <seconds>`                                                                                                                                                                                                                                             |
...
| **serve**                                   | `serve-command.ts`         | Mint a worker-hosted preview URL for a VFS app directory and open it in the leader browser. `--bridge` makes visitors driveable; the first visit announces once while later lifecycle activity stays in a bounded, leader-memory-only recorder. `serve --logs` reads that recorder without emitting a lick or waking the cone; `serve --truncate` clears records and re-arms the announcement.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `[--entry <path>] [--bridge \| --no-bridge] [--stop <token>] [--list] <directory>`; `--logs [<token>] [--lines <N>]`; `--truncate [<token>]`                                                                                                                                                                                 |
