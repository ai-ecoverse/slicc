...
| **webhook**                                 | `webhook-command.ts`       | Manage webhooks for event-driven licks. `--scoop` is required and names a scoop **or a cone** (by folder: `cone`, `cone-research`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `webhook create <endpoint>`, `webhook list`, `webhook delete <id>`                                                                                                                                                                                                                                                           |
...
| **crontask**                                | `crontask-command.ts`      | Schedule cron jobs that dispatch licks. `--scoop` names a scoop **or a cone** (by folder: `cone`, `cone-research`); omitted, the tick is resolved against the default cone at fire time                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `crontask add <name> "0 9 * * *" scoop-name "instructions..."`                                                                                                                                                                                                                                                               |
...
| **fswatch**                                 | `fswatch-command.ts`       | Watch a VFS path for changes via `globalThis.__slicc_fs_watcher` and route each change through `globalThis.__slicc_lick_handler` to a target scoop. `--scoop` also accepts a cone folder (`cone`, `cone-research`) and defaults to the unit that created the watcher. Maintains an in-process `activeWatches` map.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `fswatch create --path <path> --pattern <glob> [--scoop <name>] [--name <name>]`, `fswatch list`, `fswatch delete <id>`                                                                                                                                                                                                      |
