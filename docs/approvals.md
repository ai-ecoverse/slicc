...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| **navigate · upskill**              | Runs `upskill [--branch ..] [--path ..] <url> --all`, installing **every** skill under the advertised scope (the "already exists" check still guards duplicate installs). | Drops the install.                            |
