...
| `packages/*/CLAUDE.md`                                  | 20,000 | chars | three files grandfathered; see below |
...
Three package files exceed the 20,000-char cap as of the gate's introduction and
...
and `packages/chrome-extension/CLAUDE.md` (35,000).
