...
/// One leader computer as a Safari-shaped preview card: live JPEG, title,
/// kind chip, optional soft keys. Watch is tied to visibility so a
/// scrolled-off card stops the 2 fps stream.
