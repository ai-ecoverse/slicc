...
||||||| parent of 34738622f (chore(ios-app): raise the deployment floor to iOS 26)
...
=======
This package is NOT an npm workspace. It targets iOS 26 and is a Swift Package Manager project (`Package.swift`) plus a generated Xcode project (`SliccFollower.xcodeproj`, regenerated by `project.yml` via XcodeGen).
>>>>>>> 34738622f (chore(ios-app): raise the deployment floor to iOS 26)
