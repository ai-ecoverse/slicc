...
| `SliccFollower/Views/TabsCarouselView.swift`                                                        | Local CDP-target WKWebView carousel + remote-tab preview cards. Tab controls live in the surface content, never the navigation toolbar: nested toolbar items merge with the covered chat's at compact width and don't render at all in the regular split (#1916) |
