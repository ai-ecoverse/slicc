...
/** Detail of the `question-answer` event. */
 ...
 *
 * Purely presentational. It reports the answer as a `question-answer` event
 * and the host decides what answering means (the webapp sends it to the cone
 * as a lick). Three states: `open` (answerable), `answered` (shows the
 * answer), and `inert` (visible but not answerable — an older question, or a
