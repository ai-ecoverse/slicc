...
describe('slicc-agent-message', () => {
  ...
  describe('check variant', () => {
    ...
    it('applies the r/cy/vi/am badge accents', () => {
      ...
      expect(getComputedStyle(badges[0]).backgroundColor).toBe('rgb(244, 63, 94)');
      expect(getComputedStyle(badges[1]).backgroundColor).toBe('rgb(6, 182, 212)');
      expect(getComputedStyle(badges[2]).backgroundColor).toBe('rgb(139, 92, 246)');
      expect(getComputedStyle(badges[3]).backgroundColor).toBe('rgb(245, 158, 11)');
    });
  ...
  describe('thinking state', () => {
    ...
    it('colors the three dots rose / cyan / violet', () => {
      ...
      expect(getComputedStyle(dots[0]).backgroundColor).toBe('rgb(244, 63, 94)');
      expect(getComputedStyle(dots[1]).backgroundColor).toBe('rgb(6, 182, 212)');
      expect(getComputedStyle(dots[2]).backgroundColor).toBe('rgb(139, 92, 246)');
    });
  ...
  describe('appearance', () => {
    ...
    it('styles blockquote edge, links, and bold with the derived context accent', () => {
      ...
      expect(accent).not.toBe('rgb(139, 92, 246)');
