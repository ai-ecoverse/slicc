...
- **Release gating**: `tools/release-plan.mjs` (Linux preflight) + `release-native.mjs` — gate macOS/iOS packaging, the `slicc` Go CLI (`packages/slicc-cli/sign-and-package.sh`), Chrome Web Store / worker publish, and `@ai-ecoverse/biome-jsh`.
