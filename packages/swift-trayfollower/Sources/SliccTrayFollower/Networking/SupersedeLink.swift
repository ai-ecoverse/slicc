...
///
/// `packages/swift-traysession` carries its own copy — it is a
/// Foundation-only package with no dependency on this one, and the liveness
/// probe needs the same reading.
