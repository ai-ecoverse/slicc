/**
 * `jshd` — registration only. The body (`./jshd/run.ts`) carries help,
 * persistence, and the supervisor; those stay behind a dynamic import so
 * they are out of the worker's eager first-load graph.
 */
