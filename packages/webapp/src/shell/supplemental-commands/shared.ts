 ...
 * and the unified worker path (`<token>.preview.sliccy.ai`, plus the
 * staging variant). Used by the app-tab detector to avoid identifying
 * a preview tab as the SLICC app itself.
 */
