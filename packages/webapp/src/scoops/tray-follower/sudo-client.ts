...
/**
 * Delegated sudo prompts on behalf of a headless leader (issue #2062).
 * Fail-closed: no handler, a throw, or a withdrawn prompt all reply `deny`.
 */
export class FollowerSudoClient {
  ...
  /** A delegated sudo prompt cannot outlive its channel. */
  abortAll(): void {
