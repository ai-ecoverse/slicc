 ...
 * heuristic title. Returns as quickly as the VFS write + index update
 * allow — designed for the double-click "impatient" gesture where
 * reload latency matters more than archive title fidelity.
 */
