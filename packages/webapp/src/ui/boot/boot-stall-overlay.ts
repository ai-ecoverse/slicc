...
/**
 * Show (or update) the live boot stage while the kernel is still making
...
/** Remove the stage chip if present. Safe to call when it never rendered. */
...
export function showBootStallOverlay(
  ...
  // The stall banner names the stage itself; don't stack a second chip.
  removeBootStage(doc);
