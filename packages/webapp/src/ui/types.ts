 ...
 * shapes (`ChatMessage`, `ToolCall`, `MessageRole`, `LickState`, `Session`) in
 * `scoops/chat-types.ts` — so lower layers stop importing upward into `ui/`.
 * The UI keeps consuming them through this re-export.
 */
