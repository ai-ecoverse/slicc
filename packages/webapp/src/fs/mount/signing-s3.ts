 ...
 * region + service + clock, produces the same request with an
 ...
 *
 * Verified against AWS's canonical SigV4 v4 test vectors in
 * `tests/fs/mount/signing-s3.test.ts` (vectors embedded inline rather than
 * vendored as fixture files; the canonical inputs/outputs are stable and
 * widely documented in AWS reference materials).
 */
