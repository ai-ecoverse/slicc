...
/**
 * The refusal for a line that writes a blind path off as absent (#3459).
 * Tells the pass what it may do instead, because the alternative it will
 * reach for — rephrasing the same refutation — is refused just the same.
 */
