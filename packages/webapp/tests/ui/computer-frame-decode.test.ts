/**
 * Bytes → store → data URL. jsdom does not decode images (no load/error),
 * so Chromium `<img>` coverage lives in
 * `packages/webcomponents/tests/computer/slicc-bash-renderer-computer.test.ts`.
 */
