...
// Node's experimental localStorage is missing here, and jsdom does not
// replace it. Install a map-backed stand-in before the suite decides
// whether the storage tests can run.
