...
/**
 * Tests for the DOM half of the hover previews: what gets marked, what is
 * left alone, and that a second pass changes nothing.
 */
...
/** A parser that recognizes exactly `phrase`. */
...
describe('decorateMentions — idempotence and errors', () => {
  it('a second pass over decorated content changes nothing', async () => {
    ...
    // Force a re-run by invalidating the fingerprint.
