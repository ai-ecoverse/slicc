...
describe('tray sidecar', () => {
  ...
  describe('prompt', () => {
    ...
    // A v10 rejected ack means the leader could not hand the prompt to its
    // kernel — waiting for a turn that will never start would hang until the
    // panel-RPC timeout. Mirror the Go CLI's `promptAckRejection`.
