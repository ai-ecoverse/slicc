...
describe('LeaderSyncManager', () => {
  ...
  describe('sprinkle sync', () => {
    ...
    it('broadcastPreviewOpen sends preview.open to every follower', () => {
      ...
      manager.broadcastPreviewOpen('https://abc.def.preview.sliccy.ai/index.html');
      ...
      for (const ch of [ch1, ch2]) {
        ...
        expect(sent[0]).toMatchObject({
          type: 'preview.open',
          url: 'https://abc.def.preview.sliccy.ai/index.html',
        });
    ...
    it('broadcastPreviewOpen is a no-op when no followers are connected', () => {
      ...
      expect(() => manager.broadcastPreviewOpen('https://x.preview.sliccy.ai/')).not.toThrow();
    });
