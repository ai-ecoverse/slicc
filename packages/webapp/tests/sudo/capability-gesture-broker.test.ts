...
describe('createCapabilityGestureSudoBroker', () => {
  ...
  // The owner's own native prompt is the PRIMARY approval surface. A reason
  // that reached only the cone and tray legs would be missing from the dialog
  // a human actually sees most.
