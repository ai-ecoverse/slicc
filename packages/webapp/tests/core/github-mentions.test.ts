...
describe('ref helpers', () => {
  ...
  it('builds urls, card images and labels', () => {
    ...
    // An unknown kind uses /issues/, which GitHub redirects for PRs.
  ...
  it('cards a reference with its rendered image and label', () => {
    ...
    // An unknown kind is addressed as an issue, like githubRefUrl.
...
describe('githubCardFor', () => {
  ...
  it('cards discussions, commits and releases', () => {
    ...
    // An encoded tag stays encoded in the image address, decoded in the title.
  ...
  it('declines site pages, other hosts and accounts', () => {
    ...
    // Only an organization has account-wide discussions.
