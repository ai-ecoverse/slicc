/**
 * The bundled fake computer must emit a real 640×400 PNG/JPEG, not the
 * SOF0-only stub. Node has no OffscreenCanvas here, so this is the
 * stored-deflate PNG path.
 */
