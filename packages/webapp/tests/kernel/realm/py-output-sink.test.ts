/**
 * Python's stdout/stderr reach the realm exactly as written. The `batched`
 * handler added a newline to every line and dropped an unterminated last
 * line, so `python3 -c 'import sys; sys.stdout.write("3;14;2")'` printed
 * nothing and CMake's FindPython found no version.
 */
