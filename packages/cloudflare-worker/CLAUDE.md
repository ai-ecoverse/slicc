...
- `GET /handoffs` — lightweight handoff preview page for `https://www.sliccy.ai/handoffs#<base64url-json>`
...
- The `/handoffs` page is intentionally stateless; the URL fragment is the transport and the page only previews it.
