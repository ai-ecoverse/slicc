...
5. A run that never reached the judge is recorded with `error` and retried on the next invocation. It is reported, never counted as a fail: #3180's matrix is sparse.
