 ...
 * diagnosing the leader: calls.jsonl, events.jsonl (leader age and health per task) and
 * diagnostics/ (CLI debug output for failed dials); with BENCH_LEADER_LOG, events are also
 * marked in the leader's own log.
