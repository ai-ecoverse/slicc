...
- **Sprinkles** — everything is better with sprinkles: small, optional enhancements you can add on top of the core system. Select a newly discovered sprinkle's rail icon to open its panel. Panel actions return to the cone that opened them by default, and a panel can target a different cone or scoop for an individual action.
