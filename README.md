...
- **Hand work off from another coding agent into your live browser session.** Open a `https://www.sliccy.ai/handoffs#...` URL and let the extension queue an approval prompt inside SLICC.
