...
final class SliccBootstrapperTests: XCTestCase {
    ...
    func testFindServerBinaryFindsRepoLocalDebugBuild() throws {
        ...
        let binary = sliccDir.appendingPathComponent("sliccserver/.build/release/slicc-server")
    ...
    func testFindServerBinaryFindsSiblingDebugBuild() throws {
        ...
        let binary = workspaceRoot.appendingPathComponent("sliccserver/.build/release/slicc-server")
