...
It covers cone-strip mirroring and a follower changing one cone's model. (A
read-only-scoop spec sits next to them, `test.fixme`-gated and therefore NOT
running, until #2312 implements the behaviour.) Topology helpers:
