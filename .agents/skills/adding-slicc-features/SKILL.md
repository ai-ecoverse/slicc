...
For non-procedural system and protocol background, see [`docs/architecture.md`](../../../docs/architecture.md), [`docs/shell-reference.md`](../../../docs/shell-reference.md), and [`docs/tools-reference.md`](../../../docs/tools-reference.md).
