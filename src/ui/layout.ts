...
export class Layout {
  ...
  private get drawerZone(): TabZone { return this.primaryZone; }
  private get drawerZoneEl(): HTMLElement { return this.primaryZoneEl; }
  ...
  private buildTabbedLayout(): void {
    ...
    this.panels = {
      ...
      terminal: new TerminalPanel(terminalContainer, {
        onClearTerminal: () => { this.panels.terminal.clearTerminal(); },
      }),
  ...
  private buildSplitLayout(): void {
    ...
    threadIcon.innerHTML = '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 4h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H7l-4 3V5a1 1 0 0 1 1-1z"/><path d="M7 8h6"/><path d="M7 11h3"/></svg>';
    ...
    this.primaryZoneEl.style.cssText = 'display: flex; flex-direction: column; min-height: 0; overflow: hidden; flex: 1;';
    ...
    this.panels = {
      ...
      terminal: new TerminalPanel(this.terminalContainer, {
        onClearTerminal: () => { this.panels.terminal.clearTerminal(); this.openTerminal(); },
      }),
