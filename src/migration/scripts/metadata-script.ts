/**
 * Self-contained synchronous IIFE that extracts page metadata.
 * Designed to run in-page via CDP evaluate() — no imports allowed.
 */
export const METADATA_EXTRACT_SCRIPT = `(function () {
  var ogTags = {};
  var twitterTags = {};
  var description = '';
