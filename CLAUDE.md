...
- **Lick forwarding**: A tray follower forwards `navigate` (handoff) licks to the leader's agent instead of handling them locally. The leader stamps the follower's origin onto the forwarded lick; the leader is the origin authority.
